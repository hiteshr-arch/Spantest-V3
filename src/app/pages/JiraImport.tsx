      ...
      <div className="story-import flex flex-col h-full flex-1 min-h-0 bg-[#faf9ff]">
        ...
        <div className="flex items-center gap-3 px-6 py-3 border-b border-[#f3f0fb] bg-white">
          ...
          <div className="flex items-center gap-2">
            <Tag
              className="!text-[11px] !px-[8px] !py-0 !m-0 !leading-[22px] !border-0"
              style={{ background: "#e8f4fd", color: "#1677ff", fontWeight: 700, fontFamily: "'DM Sans', sans-serif" }}
            >
              {selectedStory.key}
            </Tag>
            <h2
        ...
        <div className="px-6 py-4 border-b border-[#f3f0fb] bg-white">
          <p
            className="!text-[#0f0a1e] text-[13px] m-0 !leading-[1.6]"
          ...
          <div className="flex items-center gap-3 mt-2">
            {storyEpic ? (
              <span className="!text-[#8b87a0] text-[11px]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                Epic: <span className="!text-[#d46b08]" style={{ fontWeight: 600 }}>{storyEpic.name}</span>
              </span>
            ) : (
              <Tag
                className="!text-[10px] !px-[6px] !py-0 !m-0 !leading-[18px] !border-0"
                style={{ background: "#f5f4f8", color: "#8b87a0", fontWeight: 600, fontFamily: "'DM Sans', sans-serif" }}
              >
                Unassigned
              </Tag>
            )}
        ...
        <div className="flex-1 overflow-auto px-6 py-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <Tag
              className="!text-[10px] !px-[6px] !py-0 !m-0 !leading-[18px] !border-0"
              style={{ background: "#f3eaff", color: "#7c3aed", fontWeight: 700, fontFamily: "'DM Sans', sans-serif" }}
            >
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <span
                        className="!text-[#0f0a1e] text-[12px] block truncate"
                        style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                      >
                        {item.name}
                      </span>
                    ...
                    <Tag
                      className="!text-[9px] !px-[5px] !py-0 !m-0 !leading-[16px] !border-0 shrink-0"
                      style={{ background: typeConfig.bg, color: typeConfig.color, fontWeight: 600, fontFamily: "'DM Sans', sans-serif" }}
                    >
                      {typeConfig.label}
                    </Tag>
                    <Tag
        ...
        {linkedItemsForStory.length > 0 && (
          <div className="px-6 py-3 border-t border-[#f3f0fb] bg-white">
            <div className="flex items-center gap-2">
              ...
              >
                <span className="text-[11px] !text-[#4c4568]" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}>
              ...
              <div className="ml-auto flex items-center gap-[6px]">
                <Tooltip title="Edit in Generator">
                  <button
                    ...
                    className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#e2dff0] bg-white text-[11px] !text-[#4c4568] hover:!text-[#7c3aed] hover:border-[#7c3aed] cursor-pointer transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                  >
                ...
                <Tooltip title="Delete from repository">
                  <button
                    ...
                    disabled={selectedItemIds.size === 0}
                    className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#e2dff0] bg-white text-[11px] !text-[#4c4568] hover:!text-[#d4183d] hover:border-[#d4183d] cursor-pointer transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                  >
                ...
                <Tooltip title="Unlink from this story">
                  <button
                    ...
                    disabled={selectedItemIds.size === 0}
                    className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#e2dff0] bg-white text-[11px] !text-[#4c4568] hover:!text-[#d46b08] hover:border-[#d46b08] cursor-pointer transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                    style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                  >
                  ...
                  {epicStories.map((s) => (
                    <Select.Option key={s.id} value={s.id} label={`${s.key} ${s.summary}`}>
                      <span className="flex items-center gap-1 text-[12px]">
                        <Tag className="!text-[9px] !px-[4px] !py-0 !m-0 !leading-[16px] !border-0" style={{ background: "#e8f4fd", color: "#1677ff", fontWeight: 700 }}>
                          {s.key}
                        </Tag>
    ...
    <div className="story-import flex h-full flex-1 min-h-0">
      ...
      <div className="story-import__left-panel w-[280px] shrink-0 border-r border-[#f3f0fb] bg-white flex flex-col">
        ...
        <div className="px-2 pt-3">
          ...
          <div
            ...
            style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: leftView === "all" ? 600 : 500 }}
          >
          ...
          <div
            ...
            style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: leftView === "unassigned" ? 600 : 500 }}
          >
        ...
        <div className="flex-1 overflow-y-auto px-2 py-2">
            ...
            return (
              <div key={epic.id} className="mb-[2px]">
                ...
                >
                  ...
                  <span
                    className={`text-[10px] min-w-[18px] text-center rounded-full px-[5px] py-[1px] shrink-0 ${
          ...
          {jiraEpics.length === 0 && !creatingEpic && (
            <div className="flex flex-col items-center gap-2 py-6">
              ...
              <p className="!text-[#8b87a0] text-[11px] text-center m-0" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                No epics yet.
              </p>
            </div>
          )}
      ...
      <div className="story-import__stories-panel flex-1 min-w-0 bg-[#faf9ff] flex flex-col">
        ...
        <div className="flex items-center gap-3 px-6 py-3 border-b border-[#f3f0fb] bg-white">
          <div className="flex items-center gap-1 min-w-0">
            <span
              className="!text-[#8b87a0] text-[12px] shrink-0 cursor-pointer hover:!text-[#7c3aed] transition-colors"
              onClick={() => setLeftView("all")}
              style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
            >
              Stories
            ...
            {breadcrumbLabel && (
              <>
                ...
                <span
                  className={`text-[12px] shrink-0 ${leftView === "unassigned" ? "!text-[#4c4568]" : "!text-[#d46b08]"}`}
                  style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}
                >
                  {breadcrumbLabel}
                </span>
          ...
          <Tooltip title="Create Story">
            <button
              ...
              className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#7c3aed] bg-[#7c3aed] text-white text-[11px] cursor-pointer hover:bg-[#6d28d9] transition-colors"
              style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}
            >
              <PlusOutlined className="text-[10px]" />
              New Story
          ...
          <Input
            ...
            allowClear
            style={{ width: 220, height: 34, fontSize: 12, fontFamily: "'DM Sans', sans-serif" }}
          />
        </div>
        ...
        <div className="flex items-center gap-4 px-6 py-2 bg-[#faf9ff] border-b border-[#f3f0fb]">
          ...
          {selectedStoryIds.size > 0 && (
            <div className="flex items-center gap-[6px] ml-auto">
              <span
                className="!text-[#7c3aed] text-[11px] mr-1"
                style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}
              >
              ...
              <Tooltip title="Move to Epic">
                <button
                  ...
                  className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#e2dff0] bg-white text-[11px] !text-[#4c4568] hover:!text-[#7c3aed] hover:border-[#7c3aed] cursor-pointer transition-colors"
                  style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                >
              ...
              <Tooltip title="Delete selected stories">
                <button
                  ...
                  className="flex items-center gap-[5px] px-[10px] py-[5px] rounded-md border border-[#e2dff0] bg-white text-[11px] !text-[#4c4568] hover:!text-[#d4183d] hover:border-[#d4183d] cursor-pointer transition-colors"
                  style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 500 }}
                >
                  <DeleteOutlined className="text-[11px]" />
                  Delete
        ...
        <div className="flex-1 overflow-auto px-6 py-4">
          {displayedStories.length === 0 ? (
            ...
            <table className="w-full text-[12px] border-collapse" style={{ fontFamily: "'DM Sans', sans-serif" }}>
              <thead>
                <tr>
                  ...
                  {["Key", "Summary", ...(leftView === "all" ? ["Epic"] : []), "Linked Items"].map((h) => (
                    <th
                      key={h}
                      className="text-left px-4 py-[10px] !text-[#8b87a0] bg-white border-b border-[#f3f0fb] whitespace-nowrap"
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-[10px] border-b border-[#f3f0fb] !text-[#0f0a1e]">
                        <span className="block" style={{ fontWeight: 500 }}>{story.summary}</span>
                      </td>
                      {leftView === "all" && (
                        <td className="px-4 py-[10px] border-b border-[#f3f0fb]" style={{ width: 160 }}>
                          {epic ? (
                            <Tag
                              className="!text-[10px] !px-[6px] !py-0 !m-0 !leading-[18px] !border-0"
                              style={{ background: "#fff7e6", color: "#d46b08", fontWeight: 600, fontFamily: "'DM Sans', sans-serif" }}
                            >
                              {epic.name}
                            </Tag>
                          ) : (
                      ...
                      <td className="px-4 py-[10px] border-b border-[#f3f0fb]" style={{ width: 110 }}>
                        {linkedCount > 0 ? (
                          <Tag
                            className="!text-[10px] !px-[6px] !py-0 !m-0 !leading-[18px] !border-0"
                            style={{ background: "#f0fdf4", color: "#15803d", fontWeight: 700, fontFamily: "'DM Sans', sans-serif" }}
                          >
                            {linkedCount} linked
                          </Tag>
                        ) : (
      ...
      >
        <div className="flex flex-col gap-3 mt-2">
          <div>
            <label className="block text-[11px] !text-[#8b87a0] mb-1" style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600 }}>
              Key (optional)
            </label>
            <Input
      ...
      >
        <p className="!text-[#4c4568] text-[12px] mb-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
          Move <span style={{ fontWeight: 600 }}>{selectedStoryIds.size} stor{selectedStoryIds.size > 1 ? "ies" : "y"}</span> to:
        </p>
        <div className="flex flex-col gap-[4px]">
          {/* Unassigned option */}
          <div
            onClick={() => setBulkMoveTargetEpicId("__unassigned__")}
            className={`flex items-center gap-2 px-3 py-[8px] rounded-md cursor-pointer transition-colors text-[12px] border ${
