        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`flex items-center gap-[5px] px-[10px] py-[4px] rounded-md border-0 cursor-pointer transition-all text-[11px] font-['DM_Sans',sans-serif] whitespace-nowrap ${
                isActive
                  ? "bg-white text-[#7c3aed] shadow-sm"
                  : "bg-transparent text-[#8b87a0] hover:text-[#4c4568]"
              }`}
    ...
    <div className="generator-chat flex flex-col h-full min-h-0">
      ...
      <div className="generator-chat__messages flex-1 overflow-auto px-4 py-4 flex flex-col gap-3 min-h-0">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center flex-1 gap-3 text-center">
            ...
            <p
              className="font-['Bricolage_Grotesque',sans-serif] text-[#0f0a1e] text-[16px]"
              style={{ fontWeight: 600 }}
            >
              Write your user story
            </p>
            <p className="font-['DM_Sans',sans-serif] text-[#8b87a0] text-[13px] max-w-[280px]">
          ...
          >
            {msg.role === "user" && (
              <div className="flex gap-[5px] mb-1 flex-wrap">
                {msg.testType && (
                  <span className="text-[10px] bg-white/20 rounded px-[6px] py-[1px] font-['DM_Sans',sans-serif] uppercase">
                    {msg.testType}
                  </span>
                )}
                {msg.mode && (
                  <span className="text-[10px] bg-white/20 rounded px-[6px] py-[1px] font-['DM_Sans',sans-serif]">
            ...
            <p className="font-['DM_Sans',sans-serif] text-[13px] whitespace-pre-wrap" style={{ fontWeight: 400 }}>
              {msg.content}
            </p>
            <p
              className={`font-['DM_Sans',sans-serif] text-[10px] mt-1 ${
            ...
            {msg.role === "assistant" && msg.scenarios && msg.scenarios.length > 0 && viewMode !== "testcase" && (
              <button
                ...
                className="flex items-center gap-[4px] mt-[6px] border-0 bg-transparent p-0 cursor-pointer hover:opacity-70 transition-opacity"
                style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600, fontSize: 11, color: "#7c3aed" }}
              >
        ...
        {viewMode === "testcase" && (
          <div className="self-start flex items-center gap-[6px]">
            <button
              ...
              className="flex items-center gap-[5px] border-0 bg-transparent cursor-pointer p-0 hover:opacity-70 transition-opacity"
              style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 600, fontSize: 12, color: "#7c3aed" }}
            >
      ...
      <div className="generator-chat__input-area border-t border-[#f3f0fb] bg-white px-4 py-3 flex flex-col gap-[10px]">
          ...
          <div className="flex gap-2 flex-wrap">
            {attachments.map((file, idx) => (
              ...
              >
                ...
                <span className="font-['DM_Sans',sans-serif] text-[11px] text-[#4c4568] max-w-[120px] truncate">
                  {file.name}
                </span>
                <span className="font-['DM_Sans',sans-serif] text-[10px] text-[#8b87a0]">{file.size}</span>
                <button
        ...
        <div className="flex items-center gap-[8px] flex-wrap">
          ...
          >
            <button
              className="flex items-center gap-[4px] rounded-lg bg-[#f5f3fa] border-0 px-[10px] py-[5px] cursor-pointer text-[11px] font-['DM_Sans',sans-serif] text-[#4c4568] hover:bg-[#ede5fb] transition-colors whitespace-nowrap"
        ...
        <div className="flex items-end rounded-xl border border-[#f3f0fb] bg-white px-1 py-1 gap-1">
          ...
          <button
            ...
            className="generator-chat__send-btn shrink-0 size-8 rounded-lg border-0 text-white flex items-center justify-center cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
