      ...
      <div className="repository__toolbar flex items-center gap-3 px-6 py-3 border-b border-[#f3f0fb] bg-white">
        ...
        <div className="flex items-center gap-1 flex-1 min-w-0">
          <span
            ...
            className="!text-[#8b87a0] text-[12px] cursor-pointer hover:!text-[#7c3aed] transition-colors shrink-0"
              ...
              <span
                ...
                className={`text-[12px] cursor-pointer transition-colors truncate ${
                  b.id === selectedFolderId
                    ? "!text-[#7c3aed]"
                    : "!text-[#8b87a0] hover:!text-[#7c3aed]"
                }`}
                style={{
                  fontFamily: "'DM Sans', sans-serif",
                  fontWeight: b.id === selectedFolderId ? 600 : 500,
                }}
              >
                {b.name}
              </span>
        ...
        {activeFilterCount > 0 && (
          <button
            ...
            className="!text-[#7c3aed] text-[11px] bg-transparent border-0 cursor-pointer hover:underline shrink-0"
