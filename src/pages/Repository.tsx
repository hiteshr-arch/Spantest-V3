...
export function Repository() {
  ...
  const columns: ColumnsType<RepoItem> = [
    ...
    },
    {
      ...
      ellipsis: true,
      render: (name: string) => (
        <span className="!text-[#0f0a1e] text-[12.5px] font-medium">
          {name}
        </span>
      ),
    },
    {
      ...
      render: (type: string) => {
        ...
        return (
          <Tag
            className="!text-[10px] !px-[8px] !py-0 !m-0 !leading-[20px] !border-0 font-semibold"
    ...
    },
    {
      ...
      render: (tt: string) => (
        <span
          ...
          style={{ color: tt === "api" ? "#d46b08" : "#7c3aed" }}
        >
          {tt}
        </span>
      ),
    },
    {
      ...
      render: (p: string) => {
        ...
        return (
          <Tag
            className="!text-[10px] !px-[8px] !py-0 !m-0 !leading-[20px] font-semibold"
    ...
    },
    {
      ...
      render: (count: number) => (
        <span className="!text-[#4c4568] text-[12px]">{count}</span>
      ),
    },
    {
      title: "Folder",
    ...
    },
    {
      ...
      width: 100,
      render: (date: string) => (
        <span className="!text-[#8b87a0] text-[11px]">{date}</span>
      ),
    },
    {
      title: "",
          ...
          <div
            ...
            className={`flex items-center gap-2 px-2 py-[6px] rounded-md cursor-pointer transition-colors text-[12.5px] ${
              selectedFolderId === null
                ? "!bg-[#f3eaff] !text-[#7c3aed] font-semibold"
                : "!text-[#4c4568] hover:bg-[#faf5ff] font-medium"
            }`}
          >
                  ...
                  expandedRowRender: (record) => (
                    <div className="py-2 px-4 bg-[#faf9ff] rounded-lg border border-[#f3f0fb]">
                      <div className="flex items-center gap-2 mb-2">
                        <span
                          className="!text-[#0f0a1e] text-[12px] font-semibold"
                        >
                        ...
                        {record.type === "script" && record.scriptFramework && (
                          <>
                            <span className="!text-[#8b87a0] text-[10px]">•</span>
                            <Tag
                              className="!text-[9px] !px-[5px] !py-0 !m-0 !leading-[16px] font-semibold"
                              color="blue"
                            >
                              Python
                            </Tag>
