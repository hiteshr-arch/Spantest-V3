      ...
      {item && (
        <div>
          <p className="!text-[#4c4568] text-[12px] mb-3">
            Move <span className="font-semibold">{item.name}</span> to:
          </p>
          <Select
...
export function BulkMoveModal({
  ...
  return (
    ...
    >
      <p className="!text-[#4c4568] text-[12px] mb-3">
        Move <span className="font-semibold">{selectedCount} item(s)</span>{" "}
        to:
      </p>
      <div
      ...
      >
        ...
        {folders.length === 0 && (
          <div className="text-center py-6">
            ...
            <p className="!text-[#8b87a0] text-[11px] mt-2 m-0">
