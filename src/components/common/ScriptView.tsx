  ...
  return (
    <div className="script-view flex flex-col h-full">
      ...
      <div className="script-view__back-bar flex items-center gap-2 px-4 py-[8px] border-b border-[#f3f0fb] bg-[#f0fdf4]/40">
        <button
          onClick={onBack}
          className="flex items-center gap-[5px] px-2 py-[4px] rounded-md border border-[#d1e7dd] bg-white !text-[#15803d] text-[11px] cursor-pointer hover:bg-[#f0fdf4] hover:border-[#15803d] transition-colors font-medium"
        >
          <ArrowLeftOutlined className="text-[10px]" />
          Back to Test Cases
        </button>
        <span
          className="!text-[#15803d] text-[11px] bg-[#dcfce7] rounded-full px-2 py-[2px] font-semibold"
        >
      ...
      <div className="script-view__toolbar flex items-center gap-3 px-4 py-[10px] border-b border-[#f3f0fb] bg-white">
        <div className="flex items-center gap-2">
          <Tag
            className="!text-[10px] !px-[6px] !py-0 !m-0 !leading-[20px] font-semibold"
            color="blue"
          >
            Python
          </Tag>
          <span
            className="!text-[#8b87a0] text-[10px] bg-[#f3f0fb] rounded px-[6px] py-[2px] font-medium"
          >
            pytest + selenium
          </span>
        </div>
        ...
        <Tooltip title="Save to Repository">
          <button
            onClick={onSave}
            className="flex items-center gap-[5px] px-3 py-[5px] rounded-md border border-[#e2dff0] bg-white !text-[#4c4568] text-[11px] cursor-pointer hover:bg-[#faf5ff] hover:border-[#7c3aed] transition-colors font-medium"
          >
      ...
      <div className="script-view__content flex flex-1 min-h-0">
            ...
            <>
              <div className="flex items-center justify-between px-3 py-[9px] border-b border-[#f3f0fb]">
                <div className="flex items-center gap-[6px]">
                  ...
                  <span
                    className="!text-[#8b87a0] text-[10px] uppercase tracking-wide font-semibold"
                  >
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-[5px] mb-[4px]">
                        <span
                          className="!text-[#b0adbe] text-[10px] w-[16px] shrink-0 font-semibold"
                        >
                          {idx + 1}.
                        </span>
                        <span
                          className="!text-[#7c3aed] text-[9px] bg-[#f3eaff] rounded px-[4px] py-[1px] font-semibold"
                        >
                          {sc.scenarioId}
                        </span>
                        <Tag
                          className="!text-[9px] !px-[4px] !py-0 !m-0 !leading-[16px] !uppercase font-semibold"
                          color={isApi ? "geekblue" : "cyan"}
                        >
                          {isApi ? "API" : "UI"}
                        </Tag>
                        <Tag
                          className="!text-[9px] !px-[4px] !py-0 !m-0 !leading-[16px] font-semibold"
                      ...
                      {/* row 2: title */}
                      <span
                        className="!text-[#0f0a1e] text-[11px] block truncate mb-[4px] font-medium"
                      >
                        {sc.title}
                      </span>
                      ...
                      <div className="flex items-center gap-[6px]">
                        <Tag
                          className="!text-[8px] !px-[4px] !py-0 !m-0 !leading-[14px] font-semibold"
                        ...
                        {lineIdx >= 0 && (
                          <span
                            className="!text-[#7c3aed] text-[9px] bg-[#f3eaff] rounded px-[3px] py-[0px] ml-auto font-medium"
                          >
                            L{lineIdx + 1}
                          </span>
                        )}
        ...
        {!sidebarOpen && (
          <div className="shrink-0 flex flex-col items-center pt-2 px-1 bg-white border-r border-[#f3f0fb]">
            ...
            <span
              className="!text-[#b0adbe] text-[9px] mt-1 [writing-mode:vertical-rl] rotate-180 font-semibold"
            >
              {scenarios.length} TC
            </span>
          </div>
                ...
                >
                  {script.code.split("\n").map((line, i) => (
                    <div key={i} className="flex hover:bg-[#2a2640] transition-colors">
                      <span
                        className="w-[50px] shrink-0 text-right pr-4 select-none !text-[#4c4568] text-[11px]"
                      >
                        {i + 1}
                      </span>
